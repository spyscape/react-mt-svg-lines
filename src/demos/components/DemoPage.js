...
export default class DemoPage extends React.Component {
        ...
        <div className='row' style={styles.row}>
          <div className='column' style={styles.column}>
            <MtSvgLines
              ...
              callback={this.getCallback(triggerCheckAnim)}
              jsOnly={jsOnly}
            >
              <SvgCheckmark />
            </MtSvgLines>
          ...
          <div className='column' style={styles.column}>
            <MtSvgLines
              ...
              callback={this.getCallback(triggerSigAnim)}
              duration={2000}
              stagger={100}
              timing='linear'
              jsOnly={jsOnly}
          ...
          <div className='column' style={styles.column}>
            <MtSvgLines
              ...
              callback={this.getCallback(triggerChartAnim)}
              duration={3000}
              stagger={50}
              timing='ease-in'
              fade
          ...
          <div className='column' style={styles.column}>
            <MtSvgLines
              ...
              callback={this.getCallback(triggerSpinnerAnim)}
              duration={1500}
              stagger={20}
              timing='linear'
            ...
            <div style={styles.info}>
              ...
              <p style={styles.props}>
                ...
                timing: <strong>linear</strong><br />
                playback: <strong>2 alternate-reverse both</strong><br />
  ...
  renderTrigger (triggerKey) {
    ...
    if (!this.state.isIE) {
      buttonsJsx.push(
        <a key='cssTrigger' style={{ ...styles.animLink, ...styles.animLinkCss }} href='#' onClick={this.getClickHandler(triggerKey, false)} >
          CSS »
        </a>
      )
    }
    ...
    buttonsJsx.push(
      <a key='jsTrigger' style={styles.animLink} href='#' onClick={this.getClickHandler(triggerKey, true)}>
        JS »
      </a>
    )
  ...
  getClickHandler (triggerKey, jsOnly) {
    return (e) => {
      e.preventDefault()
